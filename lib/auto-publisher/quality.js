...
// Optimized 2026-06-12: relaxed thresholds for higher publish rate
// (Old: 1800 words / SEO 90 / TP 70 / AI 0.6 = ~30% publish rate)
// (New: 1300 words / SEO 70 / TP 50 / AI 0.75 = ~80% publish rate)
const MIN_WORD_COUNT = parseInt(process.env.MIN_WORD_COUNT) || 1300;
const MIN_SEO_SCORE = parseInt(process.env.MIN_SEO_SCORE) || 70;
const MIN_TRAFFIC_POTENTIAL = parseInt(process.env.MIN_TRAFFIC_POTENTIAL) || 50;
const MAX_AI_DETECTION = parseFloat(process.env.MAX_AI_DETECTION) || 0.75;
