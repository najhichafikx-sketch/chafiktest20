export const TOOL_NAMES = {
  ...
  'ai-content-generator': { name: 'AI Content Generator', icon: '📢', category: 'Content Writing' },
  ...
  'thumbnail-generator': { name: 'Thumbnail Social Media', icon: '🖼️', category: 'Image AI' },
  'png-to-webp': { name: 'PNG to WebP Converter', icon: '🖼️', category: 'Image AI' }
};
...
export const TOOL_INPUT_HINTS = {
  ...
  'ai-content-generator': 'Enter your topic. Example: <code>Top 10 places to visit in Dubai this summer</code>',
...
export const TOOL_ARTICLES = {
  ...
  'ai-content-generator': { slug: 'ai-content-generator-guide', title: 'AI Content Generator: Create Viral Titles & Descriptions in Seconds', toolUrl: 'ai-content-generator' },
...
export const RELATED_TOOLS = {
  ...
  'image-to-prompt': ['video-to-prompt', 'product-image', 'png-to-webp', 'prompt-article'],
  ...
  'product-image': ['image-to-prompt', 'png-to-webp', 'product-description', 'amazon-listing'],
  ...
  'watermark-remover': ['product-image', 'image-to-prompt', 'png-to-webp', 'ai-digital-creator'],
  'png-to-webp': ['image-to-prompt', 'watermark-remover', 'product-image']
};
