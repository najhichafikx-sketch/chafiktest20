...
const CODE = (key, height, width) => `<script>atOptions={'key':'${key}','format':'iframe','height':${height},'width':${width},'params':{}};</script><script src="//www.highperformanceformat.com/${key}/invoke.js"></script>`;

const KEY = 'a64a753a91e1df2d14eac4534cea9820';

const HARDCODED_ADS = {
  header: {
    id: 'header', location: 'header', enabled: true, updated_at: '2026-01-01T00:00:00.000Z',
    code: CODE(KEY, 90, 728)
  },
  sidebar: {
    id: 'sidebar', location: 'sidebar', enabled: true, updated_at: '2026-01-01T00:00:00.000Z',
    code: CODE(KEY, 250, 300)
  },
  content_top: {
